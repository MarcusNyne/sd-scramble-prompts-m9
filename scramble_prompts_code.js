function m9_scramble_prompts_tolower(str) {
  ...
  function m9_scramble_prompts_find_child(ele, tag, cls=null) {
  ...
  function m9_scramble_prompts_update_enabled(event) {
    ...
    if (m9_scramble_prompts_check_element!=null) {
      if (m9_scramble_prompts_check_element.checked)
        m9_scramble_prompts_accordion_element.classList.add("enabled");
      else
        m9_scramble_prompts_accordion_element.classList.remove("enabled");
    }
  }
